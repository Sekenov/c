...
function Cart() {
  ...
  const handlePlaceOrder = () => {
    ...
    const newOrder = {
      ...
      items: cart.map(item => ({
        ...item,
        quantity: item.quantity // сохраняем количество каждого товара
      })),
    ...
    localStorage.setItem('orders', JSON.stringify([...updatedOrders, ...orders.filter(order => order.username !== username)]));
